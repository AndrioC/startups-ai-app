import { AiOutlineWarning } from "react-icons/ai"; // Ícone "not found"
  ...
  return (
    <div className="w-[300px] h-[350px] bg-[#F1F3F3] shadow-md rounded-lg text-gray-500">
      <div className="flex pl-5 mt-5">
        <Image src={arrowMatches} alt="matches" className="w-7 h-7" />
        <span className="text-xl font-bold mb-4 pl-5">MATCHES</span>
      </div>
      {matches.length === 0 ? (
